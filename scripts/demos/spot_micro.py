...
.. code-block:: bash
    ...
    # Usage
    ~/IsaacLab/isaaclab.sh -p scripts/demos/spot_micro.py
...
# /localhome/local-hnto/SpotMicro-IsaacLab/source/spotmicro/spotmicro/tasks/manager_based/spotmicro/flat_env_cfg.py
from spotmicro.tasks.manager_based.spotmicro.flat_env_cfg import SpotMicroFlatEnvCfg_PLAY
...
def main():
    """Main function."""
    demo_h1 = SpotMicroDemo("/localhome/local-hnto/SpotMicro-IsaacLab/model_19999.pt")
    print("model loaded: /localhome/local-hnto/SpotMicro-IsaacLab/model_19999.pt")
