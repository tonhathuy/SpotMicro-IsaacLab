...
from .spotmicro_marl_env_cfg import SpotmicroMarlEnvCfg


class SpotmicroMarlEnv(DirectMARLEnv):
    cfg: SpotmicroMarlEnvCfg

    def __init__(self, cfg: SpotmicroMarlEnvCfg, render_mode: str | None = None, **kwargs):
