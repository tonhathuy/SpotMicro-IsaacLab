...
- Verify that the extension is correctly installed by:
    ...
    - Running a task:
        ...
        ```bash
        # use 'FULL_PATH_TO_isaaclab.sh|bat -p' instead of 'python' if Isaac Lab is not installed in Python venv or conda
        ~/IsaacLab/isaaclab.sh -p scripts/<RL_LIBRARY>/train.py --task=<TASK_NAME>
        ```
    ...
    - Running a task with dummy agents:
        ...
        - Zero-action agent
            ...
            ```bash
            # use 'FULL_PATH_TO_isaaclab.sh|bat -p' instead of 'python' if Isaac Lab is not installed in Python venv or conda
            ~/IsaacLab/isaaclab.sh -p scripts/zero_agent.py --task=<TASK_NAME>
            ```
        - Random-action agent
...
We provide an example UI extension that will load upon enabling your extension defined in `source/spotmicro/spotmicro/ui_extension_example.py`.
...
```json
{
    "python.analysis.extraPaths": [
        "<path-to-ext-repo>/source/spotmicro"
    ]
}
```
